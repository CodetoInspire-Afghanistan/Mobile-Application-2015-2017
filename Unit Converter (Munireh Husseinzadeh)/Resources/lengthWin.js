function createLength() {
	...
	//------------------------------------------------	making top label
	var labelOfLength = Ti.UI.createLabel({
		text : 'تبدیل طول\nاز:                                        به:',
		font : {
	...
	var unitValues = [[1, 1.0936132983, 0.0006213689, 3.280839895, 39.37007874], [0.9144, 1, 0.0005681797, 3, 36], [1609.35, 1760.0065617, 1, 5280.019685, 63360.23622], [0.3048, 0.333333333, 0.0001893932, 1, 12], [0.0254, 0.277777778, 0.0000157828, 0.083333333, 1]];
	...
	tablesContainer.add(labelOfLength);
...
exports.createLength = createLength; 